...
func SendMail() {
	...
	smtpPort := "587" //mail services is port 25 other is 465 for SSL implicit and 587 for explicit SSL

	//Receiver
	to := []string{"luannguyen69691@gmail.com"}

	//Message
	subject := "Subject: Welcome to the company\n"
	body := "Wish you have a great day"
